...
| Ticket-autopilot static closure | `53,347` normalized UTF-8 bytes | `11` workflow files |
| Combined static prefix | `58,346` normalized UTF-8 bytes | Arithmetic sum of the two measured surfaces |
