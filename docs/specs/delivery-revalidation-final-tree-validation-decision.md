...
- [FTV-01 — Observe exact tracked completion projections](../tickets/delivery-revalidation-final-tree-validation/01-observe-exact-tracked-completion-projections.md)
- [FTV-02 — Persist and recover projected-not-integrated completion](../tickets/delivery-revalidation-final-tree-validation/02-persist-and-recover-projected-state.md)
