...
- [RDR-01 Reset stale delivery preparation after candidate invalidation](../tickets/ticket-autopilot-runner-defect-remediation/01-reset-stale-delivery-preparation.md)
