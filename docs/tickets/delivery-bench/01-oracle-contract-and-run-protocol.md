...
- Produces: [delivery-bench-oracle-contract.md](../../research/delivery-bench-oracle-contract.md)
...
## Acceptance Criteria
- [ ] Il documento risponde a ogni voce di *Not Yet Specified* della mappa o dichiara la domanda ancora aperta con il prossimo passo.
- [ ] Un runner minimo esegue una suite nascosta d'esempio su un repo consegnato in un container e scrive un profilo JSON; il repo consegnato risulta byte-identico dopo l'esecuzione.
- [ ] Le regole di isolamento sono verificabili: elenco esplicito di cosa il braccio vede a ogni richiesta e prova che la suite nascosta non è nel suo checkout.
- [ ] Il protocollo di Autopilot è descritto passo per passo e provato una volta su un repo effimero senza chiamate al modello.

## Frontier
Ready. Blocca tutto il resto.
