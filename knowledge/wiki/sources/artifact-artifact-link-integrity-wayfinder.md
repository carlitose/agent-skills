...
Compiled from `docs/specs/artifact-link-integrity-wayfinder.md`. Identity is `artifact:artifact-link-integrity-wayfinder`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
