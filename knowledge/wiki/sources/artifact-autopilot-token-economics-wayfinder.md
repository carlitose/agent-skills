---
type: source
title: "Autopilot Token Economics"
...
Compiled from `docs/specs/autopilot-token-economics-wayfinder.md`. Identity is `artifact:autopilot-token-economics-wayfinder`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
- Child source: [[sources/ticket-autopilot-token-economics-tk-01]]
- Child source: [[sources/artifact-autopilot-context-budget-unit-decision]]
- Child source: [[sources/ticket-autopilot-token-economics-tk-02]]
- Child source: [[sources/ticket-autopilot-token-economics-tk-03]]
...
- Child source: [[sources/ticket-autopilot-windows-digest-drift-wd-01]]
- Child source: [[sources/ticket-autopilot-windows-digest-drift-wd-02]]
- Child source: [[sources/artifact-cross-host-context-rollover-wayfinder]]
