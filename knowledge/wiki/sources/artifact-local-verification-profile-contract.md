---
type: source
title: "Contrato de verificación local: gate rápido y cobertura completa"
...
Compiled from `docs/specs/local-verification-profile-contract.md`. Identity is `artifact:local-verification-profile-contract`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
- Child source: [[sources/ticket-suite-cost-one-percent-06]]
