---
type: source
title: "Ticket Autopilot Parentless Base Reconciliation"
...
Compiled from `docs/specs/ticket-autopilot-parentless-base-reconciliation.md`. Identity is `artifact:ticket-autopilot-parentless-base-reconciliation`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
