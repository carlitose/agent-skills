---
type: source
title: "Ticket Autopilot Post-Commit Completion-Projection Recovery"
...
Compiled from `docs/specs/ticket-autopilot-post-commit-completion-projection-recovery.md`. Identity is `artifact:ticket-autopilot-post-commit-completion-projection-recovery`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
