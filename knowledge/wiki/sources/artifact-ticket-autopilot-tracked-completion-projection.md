---
type: source
title: "Ticket Autopilot Tracked Completion Projection Grant"
...
Compiled from `docs/specs/ticket-autopilot-tracked-completion-projection.md`. Identity is `artifact:ticket-autopilot-tracked-completion-projection`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
