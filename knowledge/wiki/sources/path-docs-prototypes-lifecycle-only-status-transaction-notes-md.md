---
type: source
title: "Lifecycle-only status transaction prototype"
identity_key: path:docs/prototypes/lifecycle-only-status-transaction/NOTES.md
identity_strength: weak
source_path: docs/prototypes/lifecycle-only-status-transaction/NOTES.md
source_digest: sha256:0a7901a9e4a511add61b32bf2ab4ee86479d9846142bb0d5e22adbee3fb9bd70
...
Compiled from `docs/prototypes/lifecycle-only-status-transaction/NOTES.md`. Identity is `path:docs/prototypes/lifecycle-only-status-transaction/NOTES.md`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
<!-- semantic-projection-v1: {"coverage":{"assumptions":{"headings":[1],"status":"present"},"decision":{"headings":[],"status":"not-identified"},"limitations":{"headings":[],"status":"not-identified"},"question":{"headings":[1],"status":"present"},"results":{"headings":[],"status":"not-identified"}},"parts":[{"index":0,"path":"wiki/sources/path-docs-prototypes-lifecycle-only-status-transaction-notes-md.md","payload_bytes":8444,"payload_sha256":"0a7901a9e4a511add61b32bf2ab4ee86479d9846142bb0d5e22adbee3fb9bd70"}],"payload_bytes":8444,"payload_sha256":"0a7901a9e4a511add61b32bf2ab4ee86479d9846142bb0d5e22adbee3fb9bd70","schema":1,"source_digest":"sha256:0a7901a9e4a511add61b32bf2ab4ee86479d9846142bb0d5e22adbee3fb9bd70","source_identity":"path:docs/prototypes/lifecycle-only-status-transaction/NOTES.md","source_kind":"prototype"} -->

| Topic | Source sections |
|---|---|
| question | 1: Prototype frame |
| assumptions | 1: Prototype frame |
...
<!-- semantic-payload-v1: {"part_index":0,"payload_bytes":8444,"payload_sha256":"0a7901a9e4a511add61b32bf2ab4ee86479d9846142bb0d5e22adbee3fb9bd70","schema":1,"source_digest":"sha256:0a7901a9e4a511add61b32bf2ab4ee86479d9846142bb0d5e22adbee3fb9bd70","source_identity":"path:docs/prototypes/lifecycle-only-status-transaction/NOTES.md"} -->
````markdown
# Lifecycle-only status transaction prototype
