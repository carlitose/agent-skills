...
# codex session 019e6ef5-8683-7362-b8f6-633bffe1177f

A codex session recorded between 2026-05-28 to 2026-05-28, holding 283 records in 557,635 bytes. Everything below is what the session itself recorded doing; none of it is asserted as project truth, because a session's own account of its work can be wrong in exactly the ways the work was.
...
- I’m now reading the runtime-related core, adapter, and tests to fit this into the current harness instead of inventing a parallel model.
