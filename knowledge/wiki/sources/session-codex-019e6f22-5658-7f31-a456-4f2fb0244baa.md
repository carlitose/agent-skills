...
# codex session 019e6f22-5658-7f31-a456-4f2fb0244baa

A codex session recorded between 2026-05-28 to 2026-05-28, holding 383 records in 421,753 bytes. Everything below is what the session itself recorded doing; none of it is asserted as project truth, because a session's own account of its work can be wrong in exactly the ways the work was.
...
- It will check that a code feature’s Generator request carries the resolved `tdd` binding, which gives us an end-to-end guard instead of only testing data shape.
- I’m committing now with the required decision/files/blocker notes in the message.
