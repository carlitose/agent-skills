...
# codex session 019e7000-d3b3-7633-8148-79231bfb6ab5

A codex session recorded between 2026-05-28 to 2026-05-28, holding 473 records in 600,994 bytes. Everything below is what the session itself recorded doing; none of it is asserted as project truth, because a session's own account of its work can be wrong in exactly the ways the work was.
...
- The config will set the production limit and record the few existing exceptions with reasons, so future growth fails without another explicit decision.
