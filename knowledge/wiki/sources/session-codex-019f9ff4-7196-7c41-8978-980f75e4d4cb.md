...
type: session
provider: codex
session_id: 019f9ff4-7196-7c41-8978-980f75e4d4cb
...
# codex session 019f9ff4-7196-7c41-8978-980f75e4d4cb

A codex session recorded between 2026-07-26 to 2026-07-26, holding 137 records in 511,055 bytes. Everything below is what the session itself recorded doing; none of it is asserted as project truth, because a session's own account of its work can be wrong in exactly the ways the work was.
...
- - `state=unknown`:
  ...
  - Rejected when `get_pr_state=true`.
