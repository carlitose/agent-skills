...
# codex session 019fada1-d415-7150-940e-6fc8d86ee544

A codex session recorded between 2026-07-29 to 2026-07-29, holding 678 records in 965,750 bytes. Everything below is what the session itself recorded doing; none of it is asserted as project truth, because a session's own account of its work can be wrong in exactly the ways the work was.
...
- Il contratto consente un claim massimo `behavior-verified` solo sul comportamento locale/interno osservato; provider live, release e merge restano esplicitamente fuori portata.
