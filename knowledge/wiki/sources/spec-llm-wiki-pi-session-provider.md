---
type: source
title: "LLM Wiki Pi session provider"
identity_key: spec:llm-wiki-pi-session-provider
identity_strength: stable
source_path: docs/specs/llm-wiki-pi-session-provider.md
source_digest: sha256:575de3530886fa92ce4b6af4e7c23eae446eeff86a344819a1c3c6333b6a64bd
...
Compiled from `docs/specs/llm-wiki-pi-session-provider.md`. Identity is `spec:llm-wiki-pi-session-provider`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
- Child source: [[sources/ticket-llm-wiki-pi-session-provider-psp-01]]
- Child source: [[sources/ticket-llm-wiki-pi-session-provider-psp-02]]
- Child source: [[sources/ticket-llm-wiki-pi-session-provider-psp-03]]

## Semantic coverage

<!-- semantic-projection-v1: {"coverage":{"decisions":{"headings":[],"status":"not-identified"},"exclusions":{"headings":[13],"status":"present"},"goals":{"headings":[12],"status":"present"},"invariants":{"headings":[18],"status":"present"},"verification":{"headings":[22],"status":"present"}},"parts":[{"index":0,"path":"wiki/sources/spec-llm-wiki-pi-session-provider.md","payload_bytes":12615,"payload_sha256":"575de3530886fa92ce4b6af4e7c23eae446eeff86a344819a1c3c6333b6a64bd"}],"payload_bytes":12615,"payload_sha256":"575de3530886fa92ce4b6af4e7c23eae446eeff86a344819a1c3c6333b6a64bd","schema":1,"source_digest":"sha256:575de3530886fa92ce4b6af4e7c23eae446eeff86a344819a1c3c6333b6a64bd","source_identity":"spec:llm-wiki-pi-session-provider","source_kind":"spec"} -->
...
| invariants | 18: Semantic invariants |
| verification | 22: Verification strategy |

## Preserved source

Literal source text; not an agent-authored summary.

<!-- semantic-payload-v1: {"part_index":0,"payload_bytes":12615,"payload_sha256":"575de3530886fa92ce4b6af4e7c23eae446eeff86a344819a1c3c6333b6a64bd","schema":1,"source_digest":"sha256:575de3530886fa92ce4b6af4e7c23eae446eeff86a344819a1c3c6333b6a64bd","source_identity":"spec:llm-wiki-pi-session-provider"} -->
````markdown
# LLM Wiki Pi session provider
...
- [PSP-03 — Bound and document large-transcript ingest](../tickets/llm-wiki-pi-session-provider/done/03-large-transcript-bound.md)
