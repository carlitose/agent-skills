---
type: source
title: "Actualizar una pull request sin mandar campos que no cambian"
identity_key: spec:pr-update-field-scope
identity_strength: stable
source_path: docs/specs/pr-update-field-scope.md
source_digest: sha256:2a992ba4a351cc3a2b0a629315d7ccad08c554b42e73cee884f872d4a59aff71
...
Compiled from `docs/specs/pr-update-field-scope.md`. Identity is `spec:pr-update-field-scope`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
- Child source: [[sources/ticket-pr-update-field-scope-puf-01]]

## Semantic coverage

<!-- semantic-projection-v1: {"coverage":{"decisions":{"headings":[],"status":"not-identified"},"exclusions":{"headings":[],"status":"not-identified"},"goals":{"headings":[],"status":"not-identified"},"invariants":{"headings":[],"status":"not-identified"},"verification":{"headings":[],"status":"not-identified"}},"parts":[{"index":0,"path":"wiki/sources/spec-pr-update-field-scope.md","payload_bytes":3866,"payload_sha256":"2a992ba4a351cc3a2b0a629315d7ccad08c554b42e73cee884f872d4a59aff71"}],"payload_bytes":3866,"payload_sha256":"2a992ba4a351cc3a2b0a629315d7ccad08c554b42e73cee884f872d4a59aff71","schema":1,"source_digest":"sha256:2a992ba4a351cc3a2b0a629315d7ccad08c554b42e73cee884f872d4a59aff71","source_identity":"spec:pr-update-field-scope","source_kind":"spec"} -->
...
<!-- semantic-payload-v1: {"part_index":0,"payload_bytes":3866,"payload_sha256":"2a992ba4a351cc3a2b0a629315d7ccad08c554b42e73cee884f872d4a59aff71","schema":1,"source_digest":"sha256:2a992ba4a351cc3a2b0a629315d7ccad08c554b42e73cee884f872d4a59aff71","source_identity":"spec:pr-update-field-scope"} -->
```markdown
# Actualizar una pull request sin mandar campos que no cambian
