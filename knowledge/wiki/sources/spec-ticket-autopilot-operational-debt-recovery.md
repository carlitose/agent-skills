---
type: source
title: "Ticket Autopilot Operational Debt Recovery"
...
Compiled from `docs/specs/ticket-autopilot-operational-debt-recovery.md`. Identity is `spec:ticket-autopilot-operational-debt-recovery`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
