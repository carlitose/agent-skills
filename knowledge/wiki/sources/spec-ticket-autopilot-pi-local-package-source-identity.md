---
type: source
title: "Resolve Pi-normalized local package source identities"
...
Compiled from `docs/specs/ticket-autopilot-pi-local-package-source-identity.md`. Identity is `spec:ticket-autopilot-pi-local-package-source-identity`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
