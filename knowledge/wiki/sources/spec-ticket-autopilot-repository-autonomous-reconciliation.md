---
type: source
title: "Repository-wide autonomous reconciliation authority"
...
Compiled from `docs/specs/ticket-autopilot-repository-autonomous-reconciliation.md`. Identity is `spec:ticket-autopilot-repository-autonomous-reconciliation`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
