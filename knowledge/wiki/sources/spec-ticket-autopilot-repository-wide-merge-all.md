---
type: source
title: "Repository-wide autonomous merge-all authority"
...
Compiled from `docs/specs/ticket-autopilot-repository-wide-merge-all.md`. Identity is `spec:ticket-autopilot-repository-wide-merge-all`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
