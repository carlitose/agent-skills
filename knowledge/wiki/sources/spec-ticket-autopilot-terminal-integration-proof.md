---
type: source
title: "Ticket Autopilot terminal integration proof"
...
Compiled from `docs/specs/ticket-autopilot-terminal-integration-proof.md`. Identity is `spec:ticket-autopilot-terminal-integration-proof`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
