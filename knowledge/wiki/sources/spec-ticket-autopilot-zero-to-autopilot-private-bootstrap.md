---
type: source
title: "Ticket Autopilot zero-to-autopilot private bootstrap"
...
Compiled from `docs/specs/ticket-autopilot-zero-to-autopilot-private-bootstrap.md`. Identity is `spec:ticket-autopilot-zero-to-autopilot-private-bootstrap`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
