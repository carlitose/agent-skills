---
type: source
title: "Record the test suite baseline"
identity_key: ticket:artifact-graph-disposition-drift/AG-01
identity_strength: stable
source_path: docs/tickets/artifact-graph-disposition-drift/done/01-record-suite-baseline.md
source_digest: sha256:719cb2d06d1b5a2a3253d174bcd9641e6e7f779f2bd3873442db733eafbcd3e3
...
run_id: b84c83e2cd0e4042
---

# Record the test suite baseline

Compiled from `docs/tickets/artifact-graph-disposition-drift/done/01-record-suite-baseline.md`. Identity is `ticket:artifact-graph-disposition-drift/AG-01`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
Completed under autopilot run `b84c83e2cd0e4042`, taken from the `completion.json` beside the source. That sidecar carries no date, so nothing here is dated from it.

## Semantic coverage

<!-- semantic-projection-v1: {"coverage":{"acceptance":{"headings":[4],"status":"present"},"exclusions":{"headings":[8],"status":"present"},"frontier":{"headings":[5],"status":"present"},"intent":{"headings":[3],"status":"present"},"testing":{"headings":[7],"status":"present"}},"parts":[{"index":0,"path":"wiki/sources/ticket-artifact-graph-disposition-drift-ag-01.md","payload_bytes":3837,"payload_sha256":"719cb2d06d1b5a2a3253d174bcd9641e6e7f779f2bd3873442db733eafbcd3e3"}],"payload_bytes":3837,"payload_sha256":"719cb2d06d1b5a2a3253d174bcd9641e6e7f779f2bd3873442db733eafbcd3e3","schema":1,"source_digest":"sha256:719cb2d06d1b5a2a3253d174bcd9641e6e7f779f2bd3873442db733eafbcd3e3","source_identity":"ticket:artifact-graph-disposition-drift/AG-01","source_kind":"ticket"} -->
...
<!-- semantic-payload-v1: {"part_index":0,"payload_bytes":3837,"payload_sha256":"719cb2d06d1b5a2a3253d174bcd9641e6e7f779f2bd3873442db733eafbcd3e3","schema":1,"source_digest":"sha256:719cb2d06d1b5a2a3253d174bcd9641e6e7f779f2bd3873442db733eafbcd3e3","source_identity":"ticket:artifact-graph-disposition-drift/AG-01"} -->
````markdown
---
ticket_schema: 1
ticket_id: "AG-01"
