---
type: source
title: "Classify the vendored llm-wiki skill in the model invocation policy"
identity_key: ticket:artifact-graph-disposition-drift/AG-02
identity_strength: stable
source_path: docs/tickets/artifact-graph-disposition-drift/done/02-classify-llm-wiki-skill.md
source_digest: sha256:fa2801f3e6864c08d8f501d1227a6e9d0785e55c83043cc29a2b09299d089045
...
Compiled from `docs/tickets/artifact-graph-disposition-drift/done/02-classify-llm-wiki-skill.md`. Identity is `ticket:artifact-graph-disposition-drift/AG-02`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
<!-- semantic-projection-v1: {"coverage":{"acceptance":{"headings":[4],"status":"present"},"exclusions":{"headings":[8],"status":"present"},"frontier":{"headings":[5],"status":"present"},"intent":{"headings":[3],"status":"present"},"testing":{"headings":[7],"status":"present"}},"parts":[{"index":0,"path":"wiki/sources/ticket-artifact-graph-disposition-drift-ag-02.md","payload_bytes":4149,"payload_sha256":"fa2801f3e6864c08d8f501d1227a6e9d0785e55c83043cc29a2b09299d089045"}],"payload_bytes":4149,"payload_sha256":"fa2801f3e6864c08d8f501d1227a6e9d0785e55c83043cc29a2b09299d089045","schema":1,"source_digest":"sha256:fa2801f3e6864c08d8f501d1227a6e9d0785e55c83043cc29a2b09299d089045","source_identity":"ticket:artifact-graph-disposition-drift/AG-02","source_kind":"ticket"} -->
...
<!-- semantic-payload-v1: {"part_index":0,"payload_bytes":4149,"payload_sha256":"fa2801f3e6864c08d8f501d1227a6e9d0785e55c83043cc29a2b09299d089045","schema":1,"source_digest":"sha256:fa2801f3e6864c08d8f501d1227a6e9d0785e55c83043cc29a2b09299d089045","source_identity":"ticket:artifact-graph-disposition-drift/AG-02"} -->
````markdown
---
ticket_schema: 1
ticket_id: "AG-02"
