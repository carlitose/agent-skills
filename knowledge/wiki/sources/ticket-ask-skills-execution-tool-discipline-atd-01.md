---
type: source
title: "Enforce routed tool-use defaults"
identity_key: ticket:ask-skills-execution-tool-discipline/ATD-01
identity_strength: stable
source_path: docs/tickets/ask-skills-execution-tool-discipline/done/01-enforce-routed-tool-use-defaults.md
source_digest: sha256:c6a104ccfafaf41232370bc3be243fe41443b64855c23d9a18ff025146d1cca6
...
run_id: ask-skills-execution-tool-discipline-atd01-v2-20260904
---

# Enforce routed tool-use defaults

Compiled from `docs/tickets/ask-skills-execution-tool-discipline/done/01-enforce-routed-tool-use-defaults.md`. Identity is `ticket:ask-skills-execution-tool-discipline/ATD-01`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
- Parent source: [[sources/spec-ask-skills-execution-tool-discipline]]

## Run

Completed under autopilot run `ask-skills-execution-tool-discipline-atd01-v2-20260904`, taken from the `completion.json` beside the source. That sidecar carries no date, so nothing here is dated from it.

## Semantic coverage

<!-- semantic-projection-v1: {"coverage":{"acceptance":{"headings":[4],"status":"present"},"exclusions":{"headings":[8],"status":"present"},"frontier":{"headings":[5],"status":"present"},"intent":{"headings":[3],"status":"present"},"testing":{"headings":[7],"status":"present"}},"parts":[{"index":0,"path":"wiki/sources/ticket-ask-skills-execution-tool-discipline-atd-01.md","payload_bytes":4285,"payload_sha256":"c6a104ccfafaf41232370bc3be243fe41443b64855c23d9a18ff025146d1cca6"}],"payload_bytes":4285,"payload_sha256":"c6a104ccfafaf41232370bc3be243fe41443b64855c23d9a18ff025146d1cca6","schema":1,"source_digest":"sha256:c6a104ccfafaf41232370bc3be243fe41443b64855c23d9a18ff025146d1cca6","source_identity":"ticket:ask-skills-execution-tool-discipline/ATD-01","source_kind":"ticket"} -->
...
<!-- semantic-payload-v1: {"part_index":0,"payload_bytes":4285,"payload_sha256":"c6a104ccfafaf41232370bc3be243fe41443b64855c23d9a18ff025146d1cca6","schema":1,"source_digest":"sha256:c6a104ccfafaf41232370bc3be243fe41443b64855c23d9a18ff025146d1cca6","source_identity":"ticket:ask-skills-execution-tool-discipline/ATD-01"} -->
```markdown
---
ticket_schema: 1
ticket_id: "ATD-01"
