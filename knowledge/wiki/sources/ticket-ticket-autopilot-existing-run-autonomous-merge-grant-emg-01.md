---
type: source
title: "Register an autonomous merge grant on an existing run"
identity_key: ticket:ticket-autopilot-existing-run-autonomous-merge-grant/EMG-01
identity_strength: stable
source_path: docs/tickets/ticket-autopilot-existing-run-autonomous-merge-grant/done/01-register-existing-run-autonomous-grant.md
source_digest: sha256:19072b3a2bc932c94e9dec6ae3d513140254020bb2c7ead063e6620b38dba393
...
run_id: existing-run-autonomous-grant-20260829
---

# Register an autonomous merge grant on an existing run

Compiled from `docs/tickets/ticket-autopilot-existing-run-autonomous-merge-grant/done/01-register-existing-run-autonomous-grant.md`. Identity is `ticket:ticket-autopilot-existing-run-autonomous-merge-grant/EMG-01`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
- Parent source: [[sources/artifact-ticket-autopilot-existing-run-autonomous-merge-grant]]

## Run

Completed under autopilot run `existing-run-autonomous-grant-20260829`, taken from the `completion.json` beside the source. That sidecar carries no date, so nothing here is dated from it.

## Semantic coverage

<!-- semantic-projection-v1: {"coverage":{"acceptance":{"headings":[4],"status":"present"},"exclusions":{"headings":[8],"status":"present"},"frontier":{"headings":[5],"status":"present"},"intent":{"headings":[3],"status":"present"},"testing":{"headings":[7],"status":"present"}},"parts":[{"index":0,"path":"wiki/sources/ticket-ticket-autopilot-existing-run-autonomous-merge-grant-emg-01.md","payload_bytes":4594,"payload_sha256":"19072b3a2bc932c94e9dec6ae3d513140254020bb2c7ead063e6620b38dba393"}],"payload_bytes":4594,"payload_sha256":"19072b3a2bc932c94e9dec6ae3d513140254020bb2c7ead063e6620b38dba393","schema":1,"source_digest":"sha256:19072b3a2bc932c94e9dec6ae3d513140254020bb2c7ead063e6620b38dba393","source_identity":"ticket:ticket-autopilot-existing-run-autonomous-merge-grant/EMG-01","source_kind":"ticket"} -->
...
<!-- semantic-payload-v1: {"part_index":0,"payload_bytes":4594,"payload_sha256":"19072b3a2bc932c94e9dec6ae3d513140254020bb2c7ead063e6620b38dba393","schema":1,"source_digest":"sha256:19072b3a2bc932c94e9dec6ae3d513140254020bb2c7ead063e6620b38dba393","source_identity":"ticket:ticket-autopilot-existing-run-autonomous-merge-grant/EMG-01"} -->
```markdown
---
ticket_schema: 1
ticket_id: "EMG-01"
