---
type: source
title: "La resolución de propiedad descarta los runs cuyo ciclo de vida ya terminó"
identity_key: ticket:ticket-autopilot-run-ownership-deadlock/ROD-01
identity_strength: stable
source_path: docs/tickets/ticket-autopilot-run-ownership-deadlock/done/ROD-01-descartar-runs-terminados.md
source_digest: sha256:7fbdd55789d7b171712dfbe4fa247812d641857360c35b7357077624d58fe687
...
run_id: 68bbf5aa94b94955
---

# La resolución de propiedad descarta los runs cuyo ciclo de vida ya terminó

Compiled from `docs/tickets/ticket-autopilot-run-ownership-deadlock/done/ROD-01-descartar-runs-terminados.md`. Identity is `ticket:ticket-autopilot-run-ownership-deadlock/ROD-01`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
- Parent source: [[sources/artifact-ticket-autopilot-run-ownership-deadlock]]

## Run

Completed under autopilot run `68bbf5aa94b94955`, taken from the `completion.json` beside the source. That sidecar carries no date, so nothing here is dated from it.

## Semantic coverage

<!-- semantic-projection-v1: {"coverage":{"acceptance":{"headings":[5],"status":"present"},"exclusions":{"headings":[],"status":"not-identified"},"frontier":{"headings":[6],"status":"present"},"intent":{"headings":[3],"status":"present"},"testing":{"headings":[8],"status":"present"}},"parts":[{"index":0,"path":"wiki/sources/ticket-ticket-autopilot-run-ownership-deadlock-rod-01.md","payload_bytes":3996,"payload_sha256":"7fbdd55789d7b171712dfbe4fa247812d641857360c35b7357077624d58fe687"}],"payload_bytes":3996,"payload_sha256":"7fbdd55789d7b171712dfbe4fa247812d641857360c35b7357077624d58fe687","schema":1,"source_digest":"sha256:7fbdd55789d7b171712dfbe4fa247812d641857360c35b7357077624d58fe687","source_identity":"ticket:ticket-autopilot-run-ownership-deadlock/ROD-01","source_kind":"ticket"} -->
...
<!-- semantic-payload-v1: {"part_index":0,"payload_bytes":3996,"payload_sha256":"7fbdd55789d7b171712dfbe4fa247812d641857360c35b7357077624d58fe687","schema":1,"source_digest":"sha256:7fbdd55789d7b171712dfbe4fa247812d641857360c35b7357077624d58fe687","source_identity":"ticket:ticket-autopilot-run-ownership-deadlock/ROD-01"} -->
```markdown
---
ticket_schema: 1
ticket_id: "ROD-01"
