---
type: source
title: "WBF-01 — Freeze and deliver exact Git-representation wiki bytes"
identity_key: ticket:wiki-git-byte-fidelity/WBF-01
identity_strength: stable
source_path: docs/tickets/wiki-git-byte-fidelity/done/01-freeze-deliver-git-bytes.md
source_digest: sha256:39be46a54a81e9b61dbbdbd1cb401ae23ad7a355af3fb805ca544f1bacde2664
...
Compiled from `docs/tickets/wiki-git-byte-fidelity/done/01-freeze-deliver-git-bytes.md`. Identity is `ticket:wiki-git-byte-fidelity/WBF-01`, which is why moving the artefact between dispositions updates this page instead of creating a second one.
...
- Parent source: [[sources/spec-wiki-git-byte-fidelity]]

## Run

Completed under autopilot run `wbf-01`, taken from the `completion.json` beside the source. That sidecar carries no date, so nothing here is dated from it.

## Semantic coverage

<!-- semantic-projection-v1: {"coverage":{"acceptance":{"headings":[4],"status":"present"},"exclusions":{"headings":[8],"status":"present"},"frontier":{"headings":[5],"status":"present"},"intent":{"headings":[3],"status":"present"},"testing":{"headings":[7],"status":"present"}},"parts":[{"index":0,"path":"wiki/sources/ticket-wiki-git-byte-fidelity-wbf-01.md","payload_bytes":4489,"payload_sha256":"39be46a54a81e9b61dbbdbd1cb401ae23ad7a355af3fb805ca544f1bacde2664"}],"payload_bytes":4489,"payload_sha256":"39be46a54a81e9b61dbbdbd1cb401ae23ad7a355af3fb805ca544f1bacde2664","schema":1,"source_digest":"sha256:39be46a54a81e9b61dbbdbd1cb401ae23ad7a355af3fb805ca544f1bacde2664","source_identity":"ticket:wiki-git-byte-fidelity/WBF-01","source_kind":"ticket"} -->
...
<!-- semantic-payload-v1: {"part_index":0,"payload_bytes":4489,"payload_sha256":"39be46a54a81e9b61dbbdbd1cb401ae23ad7a355af3fb805ca544f1bacde2664","schema":1,"source_digest":"sha256:39be46a54a81e9b61dbbdbd1cb401ae23ad7a355af3fb805ca544f1bacde2664","source_identity":"ticket:wiki-git-byte-fidelity/WBF-01"} -->
```markdown
---
ticket_schema: 1
ticket_id: "WBF-01"
