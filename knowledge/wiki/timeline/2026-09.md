...
90 dated event(s). Every date carries the rung that produced it; a date
...
timeline
    ...
    2026-09-05 : created artifact:llm-wiki-semantic-coverage-gap-diagnostic : created artifact:llm-wiki-semantic-coverage-wayfinder : created artifact:ticket-autopilot-stale-excluded-final-tree-projection-diagnostic : created ticket:llm-wiki-semantic-coverage/SW-01 : and 6 more
```
