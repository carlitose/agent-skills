...
Lifecycle of `ticket:autopilot-checkout-preparation/APM-PREP-01`, currently **completed**.
...
Completed under autopilot run `apm-checkout-preparation`. That sidecar carries no date,
so nothing here is dated from it.

Source page: [[sources/ticket-autopilot-checkout-preparation-apm-prep-01]]
