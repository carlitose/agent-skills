...
Lifecycle of `ticket:autopilot-practical-reliability/APM-03`, currently **completed**.
...
Completed under autopilot run `apm-practical-reliability`. That sidecar carries no date,
so nothing here is dated from it.

Source page: [[sources/ticket-autopilot-practical-reliability-apm-03]]
