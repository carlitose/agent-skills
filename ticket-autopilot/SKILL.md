...
For a `post-merge-verification` gate on an unstarted successor, load [merged-source verification](references/post-merge-verification.md): fresh source quality without reopening the predecessor or bypassing live gates.
