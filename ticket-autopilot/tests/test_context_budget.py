...
class ContextBudgetTests(unittest.TestCase):
    ...
    def test_repository_baseline_reproduces_the_autopilot_inventory(self) -> None:
        ...
        self.assertEqual(6_941, closure["word_count"])
        self.assertEqual(53_340, closure["normalized_bytes"])
        self.assertEqual(4_999, listing["normalized_bytes"])
        self.assertEqual(
            107_656, report["components"]["variable_leaf_input_bytes"]
        )
        self.assertEqual(165_995, report["components"]["composed_total_bytes"])
